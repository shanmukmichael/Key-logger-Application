...
class main(object):
    ...
    def __init__(self):
        ...
        tkinter.Scale(self.root, from_=1, to=60,  orient=tkinter.HORIZONTAL, cursor="hand2", takefocus=True,
                      length=200,  variable=tkinter.IntVar(value=5), command=self.change_interval).pack()
